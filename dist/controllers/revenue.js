...
export const fetchYearRevenue = async (req, res) => {
...
export const fetchRevenueCardData = async (req, res) => {
    ...
    try {
      ...
      WHERE EXTRACT(YEAR FROM created_at) = ${effectiveYear}`;
        ...
        const { numberOfInvoices, totalPaidInvoices, totalPendingInvoices } = invoiceData.rows[0] || {};
